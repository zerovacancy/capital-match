    ...
    <section id="architecture" className="section-container bg-gray-50">
      ...
      <div className="relative max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-12 border border-gray-100">
          <div className="aspect-[16/9] bg-lg-blue/5 rounded-lg flex items-center justify-center">
            <div className="text-center p-8">
              <h3 className="text-lg font-semibold text-lg-blue mb-4">System Architecture Diagram</h3>
              <p className="text-lg-gray">
                Interactive diagram showing data flows and system components will be displayed here.
              </p>
            </div>
          </div>
        </div>
