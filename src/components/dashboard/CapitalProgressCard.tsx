      ...
      <div className="flex justify-between items-center mb-2">
        <div className="flex items-center gap-2">
          ...
          <div className="text-sm">
            <span className="text-lg-text">Total Progress</span>
            <div className="font-bold text-lg-blue">{formatCurrency(metrics.hardCommitments + metrics.softCommitments)} of {formatCurrency(metrics.goalAmount)}</div>
          </div>
        </div>
      </div>
